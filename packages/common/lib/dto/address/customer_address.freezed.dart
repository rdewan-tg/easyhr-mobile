...
@override
String toString() {
  return 'CustomerAddress(id: $id, customerId: $customerId, deliveryName: $deliveryName, address: $address, salesPersonId: $salesPersonId, latitude: $latitude, longitude: $longitude, postalAddress: $postalAddress, location: $location, isPrimary: $isPrimary, companyId: $companyId, companyCode: $companyCode)';
}
...
class _CustomerAddress implements CustomerAddress {
  const _CustomerAddress({required this.id, required this.customerId, this.deliveryName, this.address, this.salesPersonId, this.latitude = 0.0, this.longitude = 0.0, this.postalAddress, this.location, this.isPrimary = false, required this.companyId, required this.companyCode});
