...
class _SettingApi implements SettingApi {
  ...
  @override
  Future<DeviceSettingResponse> findByDeviceId(String deviceId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeviceSettingResponse>(
    ...
    late DeviceSettingResponse _value;
    try {
  ...
  Future<CompanySettingResponse> getCompanySetting() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CompanySettingResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/company-setting',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CompanySettingResponse _value;
    try {
