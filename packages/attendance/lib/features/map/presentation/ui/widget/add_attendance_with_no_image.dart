...
class AddAttendanceWithNoImage extends ConsumerStatefulWidget {
  const AddAttendanceWithNoImage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _AddAttendanceWithNoImageState();
}

class _AddAttendanceWithNoImageState
    extends ConsumerState<AddAttendanceWithNoImage> {
  @override
  void initState() {
    super.initState();
