...
class _LoginState implements LoginState {
  const _LoginState({this.isLoading = false, this.isLoginSuccess = false, this.isPasswordVisible = false, this.error, final  Map<String, dynamic> loginForm = const {}}): _loginForm = loginForm;
