...
class _SignUpState implements SignUpState {
  const _SignUpState({this.signUpModel, this.isSignUpSuccess, this.isLoading = false, this.error, final  Map<String, dynamic> signUpform = const {}}): _signUpform = signUpform;
